export const initDiscount = () => {
  ...
  const updateDiscountValue = () => {
    ...
    const hasKey7 = localStorageData.hasOwnProperty('7') && localStorageData['7']['ready-check'].length > 0;
    const hasKey8 = localStorageData.hasOwnProperty('8') && localStorageData['8']['ready-check'].length > 0;
    const hasKey9 = localStorageData.hasOwnProperty('9') && localStorageData['9']['ready-check'].length > 0;
